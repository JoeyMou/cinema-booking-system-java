	...
	<head>
		...
		<div align="right" style="color:#666">
			<%
				...
				{
					out.print((String)session.getAttribute("username") + ",欢迎您");
					out.print("&nbsp&nbsp");
					out.print("<a href='LogXServlet?action=logout'>退出<a>");
					out.print("&nbsp&nbsp");
					out.print("<a href='PersonalServlet?action=showPersonalInfo'>我的高大上</a>");
				}
			%>
		</div>
		<div align="center">
			<h1 style="color:#DC4E1B">高大上电影院</h1>		
			<div class="nav"><ul> 
				<li><a href="index.jsp">首页</a></li> 
				<li><a href="MovieServlet?action=showAllMovies">正在热映</a></li>
				<li><a href="MovieServlet?action=arrangeRunningMovie">排片</a></li>
			</ul></div> 
			<br>